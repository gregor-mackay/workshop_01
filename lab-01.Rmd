...
Not Available, this could be as the 2021 values are entered as stings instead of integers or doubles or it could be as some lines don't have entrys/ have NA
...
That the majority of values are quite low but those that are high are extremely high
